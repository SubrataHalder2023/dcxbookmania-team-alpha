 ...
 */
package com.dcx.bookmania.core.constants;

/**
 * Global class for all DcxbookmaniaCore constants. You can add global constants for your extension into this class.
 */
public final class DcxbookmaniaCoreConstants extends GeneratedDcxbookmaniaCoreConstants
{
	public static final String EXTENSIONNAME = "dcxbookmaniacore";


	private DcxbookmaniaCoreConstants()
	{
		//empty
	}
