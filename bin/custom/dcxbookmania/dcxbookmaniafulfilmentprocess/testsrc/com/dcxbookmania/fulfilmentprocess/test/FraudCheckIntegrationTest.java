 ...
 */
package com.dcxbookmania.fulfilmentprocess.test;
...
import com.dcxbookmania.fulfilmentprocess.constants.DcxbookmaniaFulfilmentProcessConstants;
import com.dcxbookmania.fulfilmentprocess.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from dcxbookmaniafulfilmentprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/dcxbookmaniafulfilmentprocess/test/dcxbookmaniafulfilmentprocess-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "dcxbookmaniafulfilmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "dcxbookmaniafulfilmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "dcxbookmaniafulfilmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/dcxbookmaniafulfilmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/dcxbookmaniafulfilmentprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = DcxbookmaniaFulfilmentProcessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				DcxbookmaniaFulfilmentProcessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				DcxbookmaniaFulfilmentProcessConstants.ORDER_PROCESS_NAME);
