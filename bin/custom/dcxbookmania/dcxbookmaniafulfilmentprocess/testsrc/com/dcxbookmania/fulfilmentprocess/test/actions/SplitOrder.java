 ...
 */
package com.dcxbookmania.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(DcxbookmaniaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(DcxbookmaniaFulfilmentProcessConstants.PARENT_PROCESS);
