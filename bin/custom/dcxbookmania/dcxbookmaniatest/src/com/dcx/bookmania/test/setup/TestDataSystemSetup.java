 ...
 */
package com.dcx.bookmania.test.setup;
...
import com.dcx.bookmania.test.constants.DcxbookmaniaTestConstants;
import com.dcx.bookmania.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = DcxbookmaniaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/dcxbookmaniatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/dcxbookmaniatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/dcxbookmaniatest/import/cstickets.impex");
			...
			importImpexFile(context, "/dcxbookmaniatest/import/csquotes.impex");
		}
	}
}
