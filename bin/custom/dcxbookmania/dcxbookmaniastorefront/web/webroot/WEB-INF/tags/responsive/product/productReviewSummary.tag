...
<div class="rating"style="margin: 1rem 40rem 2rem 1rem;
	...
	<c:choose>
		<c:when test="${showLinks}" >
			...
			<a href="#tabreview" class="js-writeReviewTab" style="color:black;font-size:19px;font-family:ui-serif"><spring:theme code="review.write.title" /></a>
		</c:when>
		<c:otherwise>
