		...
		<div class="mini-cart-body">
			<c:choose>
				<c:when test="${numberShowing > 0 }">
					<div class="legend">
						...
						<c:if test="${numberItemsInCart > numberShowing}">
							<a href="${fn:escapeXml(cartUrl)}"><spring:theme
									code="popup.cart.showall" /></a>
						</c:if>
					</div>
											...
											<c:if
												...
												<div class="itemColor">
													<span class="label"><spring:theme
														...
														src="${fn:escapeXml(baseOptionQualifier.image.url)}"
					...
					<a href="${fn:escapeXml(cartUrl)}"
						class="btn btn-primary btn-block mini-cart-checkout-button"
						style="background-color: #89C35C; border-color: #89C35C; border-radius: 25px !important;">
						<spring:theme code="${miniCartProceed }" />
					</a>
					<a href=""
						class="btn btn-default btn-block js-mini-cart-close-button"
						style="background-color: #FBB917; border-color: #FBB917; border-radius: 25px !important;">
				...
				<c:otherwise>
					...
					<a href=""
						class="btn btn-default btn-block js-mini-cart-close-button"
						style="border-radius: 5rem !important; background-color: #FBB917; border-color: #FBB917;">
