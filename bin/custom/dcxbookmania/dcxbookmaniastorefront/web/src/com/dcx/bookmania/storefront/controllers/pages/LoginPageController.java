 ...
 */
package com.dcx.bookmania.storefront.controllers.pages;
...
import com.dcx.bookmania.storefront.controllers.ControllerConstants;
import com.dcx.bookmania.storefront.pages.DcxbookmaniaRegisterform;
//import com.dcx.bookmania.storefront.pages.dcxbookmaniaRegisterform;
...
public class LoginPageController extends AbstractLoginPageController
{
	...
	public String doRegister(@RequestHeader(value = "referer", required = false) final String referer,
			final DcxbookmaniaRegisterform form, final BindingResult bindingResult, final Model model,
	...
	protected String customProcessRegisterUserRequest(final String referer, final DcxbookmaniaRegisterform form,
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(new DcxbookmaniaRegisterform());
		model.addAttribute(new GuestForm());
